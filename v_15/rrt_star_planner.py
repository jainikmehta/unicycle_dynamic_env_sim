...
class RRTStar:
    ...
    def __init__(self, start, goal, obstacles_static, obstacles_dynamic, bounds,
        ...
        self.dynamic_obs = obstacles_dynamic # FIX: Store dynamic obstacles
    ...
    def is_collision_free(self, p_new, p_parent=None):
        ...
        # --- FIX: Dynamic Obstacle Check ---
        # Check against the *current measured position* of dynamic obstacles
