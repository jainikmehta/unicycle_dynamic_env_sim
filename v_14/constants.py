...
# --- NMPC Parameters (v10 style) ---
Q_path = np.diag([5.0, 5.0])    # State cost (path tracking)
# Q_vel is not used in the v10 cost function
R = np.diag([0.1, 0.1])         # Control cost (a, alpha)
D_SAFE = 1.0                    # Safety margin (m)
CBF_GAMMA = 1.0                 # CBF gain (alpha)
# CBF_SLACK_WEIGHT removed
